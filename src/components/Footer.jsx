  ...
  return (
    <footer className="footer">
      <div className="social-icons">
        <a href="https://discord.com/invite/h5dfqzGZ22" target="_blank" rel="noopener noreferrer"><FaWhatsapp /></a>
      ...
      <p className="footer-text">
        Youth Code Camp is fiscally sponsored by The Hack Foundation (d.b.a. Hack Club), a 501(c)(3) nonprofit (EIN: 81-2908499). Copyright © 2025.
      </p>
    </footer>
  );
};
